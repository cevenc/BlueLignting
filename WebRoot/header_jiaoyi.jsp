...
<div >
	<div class="zaixian">
		<img src="img/fangyuanzaixian.jpg" />
	</div>
	<div class="wrap">
		<div class="header">
			<div class="header_a">
				<div class="header_h">
					...
					<a href = "/bluelighting/user/quit.action">退出登陆</a><br>
					<%}%>
			...
			<div class="header_f">
				<div class="header_s">
					<a href="<%=basePath%>user/firstload.action" class="sed">首&nbsp;&nbsp;页</a>
					<a href="<%=basePath%>user/firstload.action">二手房</a>
					<a href="<%=basePath%>user/zxnewsaction.action">房产资讯</a>
					<a href="<%=basePath%>index.jsp">关于蓝光易居</a>
				</div>
				
				<div class="hf_fr"><img src="img/pic2_03.png"/><a href="index.jsp">返回蓝光易居</a>				</div>
			</div>
		</div>
		<div style="clear:both"></div>