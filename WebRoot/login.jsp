...
<div class="logincon">
			...
			<%String msg = (String)request.getAttribute("message"); %>
				<table style="margin:auto">
					...
					<tr>
						<td/>
						<td><input id="loginb" style="background:url(img/landb-now.png);width:80px;color:#fff;font-weight: bold;border:1px #CC9900;cursor:pointer;padding:7px;" type="submit" value="用户登录" /></td>
					</tr>					
				</table>
				</form>
			</div>
		...
		<div class="zhucecon">
			...
			<form action="/bluelighting/user/regist.action" method = "post">
				...
				<table style="margin:auto">
					...
					<tr>
						<td/>
						<td><input id="loginb"style="background:url(img/landb-now.png);width:80px;color:#fff;font-weight: bold;border:1px #CC9900;cursor:pointer;padding:7px;"" type="submit" value="注册" /></td>
					</tr>
